...
export function Settings({ lang, wm, theme, onTheme, onLang, onReset, apps }) {
  const T = lang === "en" ? {
    ...
    probeHint: "If only Control or Alt appears, the letter never reached the browser: something else on the machine has claimed that combination, and no page can take it back. Use the dock.",
    ...
    probeHint: "Control이나 Alt만 나오면 글자 키가 브라우저까지 오지 않은 것입니다. 다른 프로그램이 그 조합을 전역 단축키로 잡고 있고, 웹 페이지가 되찾을 방법은 없습니다. 독을 쓰세요.",
